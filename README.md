...
- Controlling of a LE Mesh light bulb using LE Mesh Set Level messages

## Instructions
To demonstrate the app, work through the following steps:

1. Build and download the application to the AIROC&#8482; board.
2. Build and download Mesh\_LightDimmable application to another AIROC&#8482; board.
...
10. For 20721B2 based AIROC&#8482; kits, use the Custom button on audio shield board as application button rather than the button on the base board.
